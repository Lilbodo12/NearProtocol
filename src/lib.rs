...
#[derive(Debug)]
pub struct NearProtocolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NearProtocolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NearProtocol processing");
    
    let mut processor = NearProtocolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NearProtocolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NearProtocolProcessor::new(false);
